...
<?php include 'header_required.php' ?>
	...
	<meta name="Keywords" content="<?php { echo $keywords; } ?>, courses, conferences, professional training, training, professional development, online courses, review, reviews, training providers">
