	...
	#signin-content .sign-up-linkedin {
		...
		<div class="container" id="topnav">
			...
			<paper-action-dialog backdrop id="si-dialog" heading="Sign In"
						  transition="paper-dialog-transition-bottom" style="display:none;">S1
				<div id="signin-content">S2
					<div class="row 25% uniform">S3
						<div class="5u" style="border-right:1px solid #d7d7d7;padding-bottom:20px;margin-left:20px;margin-top:20px;padding-right:205px;">S4
						...
						<div class="5u" style="padding-left:40px;">S5
